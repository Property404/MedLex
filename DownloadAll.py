...
dartmouth_links=tools.scrape.get_links_by_type(["xls","xlsx"],"http://www.dartmouthatlas.org/tools/downloads.aspx")

print("\tDownloading links")
tools.scrape.download_links(dartmouth_links,"./Dartmouth_Files_TEMP")
...
for i in os.listdir("./Dartmouth_Files_TEMP"):
    tools.excel_to_csv.excel_to_csv("./Dartmouth_Files_TEMP/"+i,"./data/Dartmouth_Files/")
